...
public class SplitCountingVerify extends SplitCounting {

	public SplitCountingVerify(final UnionFind u) {
		super(u);
	}

	public SplitCountingVerify(final UnionFind u, final int threads) {
		super(u, threads);
	}
